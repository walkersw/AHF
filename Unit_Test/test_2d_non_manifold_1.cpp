...
int main()
{
    ...
    TM.Reserve_Cell(4);
    TM.Append_Cell(1,2,3);
    TM.Append_Cell(2,4,3);
    TM.Append_Cell(2,5,3);
    TM.Append_Cell(2,3,6);
    ...
    v2hfs_REF[ 1].Set(3,1,1);
    v2hfs_REF[ 2].Set(3,1,2);
    v2hfs_REF[ 3].Set(3,2,2);
    v2hfs_REF[ 4].Set(3,3,2);
    v2hfs_REF[ 5].Set(3,4,3);
    v2hfs_REF[ 6].Set(4,2,1);
    v2hfs_REF[ 7].Set(4,2,3);
    v2hfs_REF[ 8].Set(5,3,1);
    v2hfs_REF[ 9].Set(5,3,3);
    v2hfs_REF[10].Set(6,4,1);
    v2hfs_REF[11].Set(6,4,2);
    // error check
    ...
    Cell_REF[ 0].Set(2,3,hf.Set());
    // Cell #2
    Cell_REF[ 1].Set(0,2,hf.Set());
    Cell_REF[ 1].Set(1,4,hf.Set(3,2));
    Cell_REF[ 1].Set(2,3,hf.Set());
    // Cell #3
    Cell_REF[ 2].Set(0,2,hf.Set());
    Cell_REF[ 2].Set(1,5,hf.Set(4,3));
    Cell_REF[ 2].Set(2,3,hf.Set());
    // Cell #4
    Cell_REF[ 3].Set(0,2,hf.Set());
    Cell_REF[ 3].Set(1,3,hf.Set());
    Cell_REF[ 3].Set(2,6,hf.Set(1,1));
    // error check
    ...
    Vtx2HalfFacets_REF[ 2].Set( 3,4,1);
    Vtx2HalfFacets_REF[ 3].Set( 4,2,3);
    Vtx2HalfFacets_REF[ 4].Set( 5,3,3);
    Vtx2HalfFacets_REF[ 5].Set( 6,4,2);
    // error check
    ...
    TM.Get_Cells_Attached_To_Vertex(V_IN, 4, cell_ind_1);
    const CellIndType cell_ind_1_REF[4] = {4, 1, 2, 3};
    ...
    const  VtxIndType V1 = 2;
    const CellIndType C1 = 1;
    const CellIndType C2 = 2;
    ...
    attached_REF[1].Set(3,2);
    attached_REF[2].Set(4,3);
    ...
    const VtxIndType uv_REF[6] = {1, 2, 3, 4, 5, 6};
